...
| 15 | `technical/reports_email.adoc` | Λείπουν οδηγίες πλοήγησης στο Jmix Reports για δημιουργία/επεξεργασία templates | Προστέθηκε ενότητα με πρόσβαση, πίνακα system codes, βήματα επεξεργασίας, screenshots | ΟΛΟΚΛΗΡΩΘΗΚΕ |
...
*Τελευταία ενημέρωση: 2026-06-12 — 38/38 ολοκληρώθηκαν. Audit ολοκληρώθηκε πλήρως.*
